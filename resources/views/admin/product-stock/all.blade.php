    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> All Product Stock Information</h3>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{url('dashboard/product/purchase/add')}}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-plus-circle"></i> Add Product Purchase</a>
                    </div>
                    ...
                    <div class="col-md-7">
                        @if(Session::has('success_soft'))
                          <div class="alert alert-success alertsuccess" role="alert">
                             <strong>Success!</strong> Product delete  success.
                          </div>
                        @endif
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          @if($data->product_image!='')
                                            <img src="{{asset('uploads/product/'.$data->product_image)}}" alt="product image" class=" table_image_40">
                                          @else
                                            <img src="{{asset('uploads/noimg.png')}}" alt="no-image" class=" table_image_40">
                                          @endif
                                        </td>
                                        <td class="text-center">
                                            <a href="{{url('dashboard/product/stock/view/'.$data->product_slug)}}"><i class="fa fa-plus-square fa-lg view_icon"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
