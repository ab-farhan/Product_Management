                            ...
                            <table class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{Str::words($data->product_details,3)}}</td>
                                        <td>{{$data->product_remarks}}</td> 
                                        <td>
                                            @if($data->product_image!='')
                                                <img class="table_image_40" src="{{asset('uploads/product/'.$data->product_image)}}" alt="product-photo"/>
                                            @else
                                                <img class="table_image_40" src="{{asset('uploads')}}/avatar-black.png" alt="user-photo"/>
                                            @endif
                                        </td>
                                        <td>
                                            <a href="{{url('dashboard/product/view/'.$data->product_slug)}}"><i class="fa fa-plus-square fa-lg view_icon"></i></a>
                                            <a href="{{url('dashboard/product/edit/'.$data->product_slug)}}"><i class="fa fa-pencil-square fa-lg edit_icon"></i></a>
