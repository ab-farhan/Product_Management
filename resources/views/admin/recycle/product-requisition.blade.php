...
@section('content')
    @php
        $all=App\ProductRequisition::where('pr_status',0)->orderBy('pr_id','DESC')->get();
    @endphp
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> Recycle All Requisition</h3>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{url('dashboard/product/requisition')}}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-th"></i> All product Requisition</a>
                    </div>
                            ...
                            <table id="alltableinfo" class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javaScript:void(0)" title="restore" id="restore" data-toggle="modal" data-target="#restoreModal" data-id="{{$data->pr_id}}"><i class="fa fa-refresh fa-lg restore_icon"></i></a>
                                            <a href="javaScript:void(0)" title="delete" id="softDelete" data-toggle="modal" data-target="#softDelModal" data-id="{{$data->pr_id}}"><i class="fa fa-trash fa-lg delete_icon"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
...
<div id="restoreModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
        <div class="modal-content p-0 b-0">
            <form method="post" action="{{url('dashboard/product/requisition/restore')}}">
              @csrf
              <div class="card mb-0">
                <div class="card-header">
...
<div id="softDelModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
        <div class="modal-content p-0 b-0">
            <form method="post" action="{{url('dashboard/product/requisition/delete')}}">
              @csrf
              <div class="card mb-0">
                <div class="card-header">
                    <h3 class="card-title float-left"><i class="fa fa-gg-circle"></i> Confirm Message</h3>
