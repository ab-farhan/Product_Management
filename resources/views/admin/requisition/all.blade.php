...
<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        <h4 class="pull-left page-title bread_title">Requisition</h4>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-8">
                        <h3 class="card-title card_top_title"><i class="fa fa-gg-circle"></i> All Product Requisition Information</h3>
                    </div>
                ...
                <div class="row">
                    ...
                    @if(Session::has('success_soft'))
                        <div class="alert alert-success alertsuccess" role="alert">
                            <strong>Success!</strong> Product requisition delete  success.
                        </div>
                    @endif
                            ...
                            <table class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($data->pr_requisition_status==0)
                                              <a href="{{url('dashboard/product/distribution/request/'.$data->pr_code)}}" class="btn btn-sm btn-primary">Distribute</a>
                                            @endif
                                        </td>
                                        <td>
                                            <a href="{{url('dashboard/product/requisition/view/'.$data->pr_slug)}}"><i class="fa fa-plus-square fa-lg view_icon"></i></a>
                                           
                                            <a href="#" title="delete" id="softDelete" data-toggle="modal" data-target="#softDelModal" data-id="{{$data->pr_id}}"><i class="fa fa-trash fa-lg delete_icon"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
...
<div id="softDelModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none">
    <div class="modal-dialog">
        <div class="modal-content p-0 b-0">
            <form method="post" action="{{url('dashboard/product/requisition/softdelete')}}">
              @csrf
              <div class="card mb-0">
                <div class="card-header">
