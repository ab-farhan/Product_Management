                            ...
                            <table class="table table-bordered custom_table mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{url('dashboard/user/view/'.$data->username)}}"><i class="fa fa-plus-square fa-lg view_icon"></i></a>
                                            <a href="{{url('dashboard/user/edit/'.$data->username)}}"><i class="fa fa-pencil-square fa-lg edit_icon"></i></a>
